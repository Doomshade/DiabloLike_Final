...
import cz.helheim.rpg.diablolike.api.item.Identifiable;
import cz.helheim.rpg.diablolike.api.item.Scroll;
...
import static cz.helheim.rpg.diablolike.item.LoreParser.LA_PATTERN;
import static cz.helheim.rpg.diablolike.item.LoreParser.SAPI_PATTERN;
